...
for i in range(0, 6):
    ...
    # PLOT 
    fig, ax = plt.subplots()
    fig.suptitle('Window size 25min - Prediction Window 30min' , fontsize=14, fontweight='bold')
    ...
    ax.legend()
    fig.savefig('graphs_h//' + name + 'h.png')
